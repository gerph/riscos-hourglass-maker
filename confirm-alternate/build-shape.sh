...
# This source image is taken from https://thenounproject.com/icon54app/collection/selection-cursors-line-icon/?i=230216
srcsize=26x50
convert "${exclude_args[@]}" source.png -resize "$srcsize" frame_0.png
...
# The palette to use for processing - cream and grey
palette=("255 255 255" "238 238 170" "0 0 0" "85 85 85")
